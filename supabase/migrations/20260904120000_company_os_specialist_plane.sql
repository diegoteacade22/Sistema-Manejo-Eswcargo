...
BEGIN
  ...
  VALUES (
    'agent-contract:general-manager-ai-v3:3.1.3',
  ...
  IF NOT EXISTS (
    ...
    WHERE id = 'agent-contract:general-manager-ai-v3:3.1.3'
    ...
    RAISE EXCEPTION 'Company OS specialist plane contract 3.1.3 is not canonical';
  END IF;
END;
$company_os_specialist_plane_migration$;
