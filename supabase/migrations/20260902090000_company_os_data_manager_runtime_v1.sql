...
INSERT INTO public."CompanyOsAgentSchedule" (
  ...
  CASE
    WHEN (((now() AT TIME ZONE 'America/New_York')::date + time '08:15:00') AT TIME ZONE 'America/New_York') > now()
      THEN (((now() AT TIME ZONE 'America/New_York')::date + time '08:15:00') AT TIME ZONE 'America/New_York')
    ELSE ((((now() AT TIME ZONE 'America/New_York')::date + 1) + time '08:15:00') AT TIME ZONE 'America/New_York')
  END,
  NULL,
