...
INSERT INTO public."CompanyOsAgentSchedule" (
  ...
  'schedule_general_manager_daily_v1', 'general-manager-ai-v3', 'daily-management-baseline', 1,
  'DAILY', time '08:30:00', 'America/New_York', NULL, true,
  'MANAGEMENT_BASELINE', 'BASELINE', '{"maxOutputTokens":3000,"targetTotalTokens":12000}'::jsonb,
  now() + interval '3 minutes', NULL,
  'general-manager-ai-v3:daily-management-baseline:v1'
)
