...
BEGIN
  ...
  VALUES (
    'agent-contract:general-manager-ai-v3:3.1.4',
  ...
  IF NOT EXISTS (
    ...
    WHERE id = 'agent-contract:general-manager-ai-v3:3.1.4'
    ...
    RAISE EXCEPTION 'Company OS General Manager runtime contract 3.1.4 is not canonical';
  END IF;
END;
$company_os_general_manager_runtime_3_1_4_migration$;
