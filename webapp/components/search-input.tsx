...
export function SearchInput({ placeholder = 'Buscar...' }: { placeholder?: string }) {
    ...
    return (
        <div className="flex items-center space-x-2 bg-slate-800/90 p-1 rounded-lg border border-slate-700 focus-within:ring-2 ring-violet-500/50 transition-all shadow-sm">
