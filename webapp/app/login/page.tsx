...
export default function LoginPage() {
    ...
    useEffect(() => {
        ...
        const autoLoginEnabled = process.env.NEXT_PUBLIC_AUTO_LOGIN_ADMIN === 'true';

        if (!isLocalHost || !autoLoginEnabled) return;
        ...
        formData.set('password', 'dev-bypass');
                ...
                <Card className="bg-slate-900/50 border-slate-800 backdrop-blur-xl shadow-2xl border-[1.5px]">
                    <CardHeader className="space-y-1 pt-8">
                        ...
                        <CardDescription className="text-center text-slate-400">
                            {autoLoginRunning ? 'Ingresando automáticamente como admin...' : 'Ingrese sus credenciales para continuar'}
                        </CardDescription>
                    </CardHeader>
