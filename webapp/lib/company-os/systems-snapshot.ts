...
export async function buildSystemsSnapshot() {
  ...
  const assets: SystemsAsset[] = [
    ...
    asset({ assetId:'ollama-qwen-local', name:'Ollama Qwen Local', category:'AI_PROVIDER', provider:'Ollama', runtime:'qwen3:14b-q4_K_M', region:'DiegoServer', safeReference:null, lifecycleStatus:'ACTIVE', healthStatus:'UNOBSERVED', observationMode:'DECLARED_FROM_CONFIG', observationLabel:'Proveedor local declarado por contrato; su inferencia se verifica en DiegoServer', criticality:'HIGH', coverageStatus:'DECLARED', confidence:.9, warnings:['Vercel no puede observar el endpoint loopback de DiegoServer'] }),
